...
function updateDirIcon() {
    ...
    const icon = document.querySelector('.dir-toggle i');
    if (icon) {
        icon.setAttribute('data-lucide', dir === 'rtl' ? 'align-right' : 'align-left');
        if (window.lucide) {
            window.lucide.createIcons();
        }
    }
    ...
    header.innerHTML = `
        <div class="container flex justify-between items-center">
            ...
            <nav class="nav-links">
                ...
                <button class="dir-toggle mobile-only-toggle" onclick="toggleDirection()" title="Toggle RTL/LTR">
                ...
                <a href="services.html" data-index="05">Services</a>
